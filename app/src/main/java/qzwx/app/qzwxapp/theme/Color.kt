...
val secondaryLight = Color(0xFFF39C12) // 温暖橙黄色
val onSecondaryLight = Color(0xFF000000)

val tertiaryLight = Color(0xFFE74C3C) // 活力红色
...
val secondaryDark = Color(0xFFE67E22) // 深橙色
val onSecondaryDark = Color(0xFF000000)

val tertiaryDark = Color(0xFFC0392B) // 深红色
